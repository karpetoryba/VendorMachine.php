...
<html>
    ...
    <form action="../controller/delivery-destination.php" method="POST">
        ...
        <input type="text" id="shippingAddress" name="shippingAddress" pattern=".*\s+.*" required><br><br>

        <label for="shippingCity">Ville :</label><br>
        <input type="text" id="shippingCity" name="shippingCity"  pattern=".*\s+.*" required><br><br>

        <label for="shippingCountry">Pays :</label><br>
        <input type="text" id="shippingCountry" name="shippingCountry"  pattern=".*\s+.*" required><br><br>
